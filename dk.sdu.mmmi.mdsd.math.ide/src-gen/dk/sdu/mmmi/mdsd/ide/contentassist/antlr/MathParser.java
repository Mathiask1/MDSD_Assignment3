...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalUseAccess().getArgsAssignment_3_0(), "rule__ExternalUse__ArgsAssignment_3_0");
			builder.put(grammarAccess.getExternalUseAccess().getArgsAssignment_3_1_1(), "rule__ExternalUse__ArgsAssignment_3_1_1");
