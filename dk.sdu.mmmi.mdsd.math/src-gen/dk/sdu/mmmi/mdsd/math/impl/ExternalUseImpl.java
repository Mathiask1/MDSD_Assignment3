 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ExternalUseImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUseImpl extends ExpressionImpl implements ExternalUse
{
  ...
  public EList<Expression> getArgs()
  {
    if (args == null)
    {
      args = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.EXTERNAL_USE__ARGS);
    }
    return args;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.EXTERNAL_USE__ARGS:
