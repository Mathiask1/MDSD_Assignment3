...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL_USE__ARGS = EXPRESSION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExternalUse#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Args</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExternalUse#getArgs()
   * @see #getExternalUse()
   * @generated
   */
  EReference getExternalUse_Args();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference EXTERNAL_USE__ARGS = eINSTANCE.getExternalUse_Args();
